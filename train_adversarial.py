...
def main():
    ...
    parser.add_argument('--name', type=str, default='adv_classifier', help='model name')
    ...
    parser.add_argument('--mf', type=str, default='/tmp/adv_classifier.pt', help='mnist data directory')
    parser.add_argument('--cf', type=str, default='/tmp/classifier.pt', help='classifier model file')
    parser.add_argument('--eps', type=float, default=0.3, help='adversarial perturbation strength')
    args = parser.parse_args()

    # initialize gan model
    classifier = AdversarialClassifier(args)
